...
import { IApplication, ISubscription } from "@/models";

// POST /api/subscriptions/[id]/delete - Delete subscription (authenticated, owner only)
export async function POST(
  ...
  try {
    ...
    const application = await findById<IApplication>(
      "applications",
