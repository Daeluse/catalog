...
export default function DashboardPage() {
  ...
  const [deleteConfirm, setDeleteConfirm] = useState<{ isOpen: boolean; module: Module | null }>({
    isOpen: false,
    module: null,
  })
  ...
  const { data, loading, refetch } = useFetch<PaginatedResponse<Module>>('/api/modules')
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="p-6">
            ...
            <p className="mt-2 text-3xl font-bold text-zinc-900 dark:text-white">
              {modules.reduce((sum, m) => sum + m.totalDownloads, 0).toLocaleString()}
            </p>
          </Card>
          <Card className="p-6">
            <p className="text-sm font-medium text-zinc-600 dark:text-zinc-400">
                ...
                <Card key={module._id} className="p-6">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="ml-4 flex gap-2">
                      ...
                      <Button as={Link} href={`/dashboard/modules/${module.name}/edit`} size="sm">
                        Edit
                      </Button>
                      <Button
                        onClick={() => setDeleteConfirm({ isOpen: true, module })}
                        variant="secondary"
                        size="sm"
